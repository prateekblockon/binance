...
<body>
		...
		<div class="verifyLayout" ng-controller="verifyLayoutCtr">
			<div class="main">
				<a href="#" class="logo"><img src="<?php echo logo_url();?>"></a>
	...
	<?php if($this->session->flashdata('success')){ ?>
		...
		<div ng-controller="forgotPwdCtr">
			...
			<div class="f-prz formWrapLR">
				...
				<form class="loginReg-form" action="<?php echo userdetails_url()?>forgotPassword/forgotPassword" method="POST"   novalidate="novalidate">
					...
					<div class="filde">
				<p class="login-tip f-cb"><span class="f-fr" ng-if="notChinese">{{"Not on Binance yet?" | T}} <a href="<?php echo userdetails_url();?>register" class="yellow">{{'Register' | T}}</a></span><a href="<?php echo userdetails_url();?>login" class="yellow f-fl">{{'Login' | T}}</a></p>
			</div>
				</form>
		...
		<script src="<?php echo asset_url();?>js/gt.js"></script>
			...
			<div class="verifyBottom">
				...
				<div class="item">© 2017  <?php echo project_name();?> All Rights Reserved</div>
			</div>
		</div>
