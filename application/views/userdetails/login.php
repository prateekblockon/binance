...
function drop(ev){
  ...
  window.location = '<?php if( ($this->session->userdata("isPhoneFactor")==false) && ($this->session->userdata("isTwoFactor")==false) ){  echo trading_url();?>trade?curr=<?php echo base64_encode("BCH/INR"); } else{    

 echo userdetails_url()."login/twofa_verify";
