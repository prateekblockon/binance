...
<html xmlns:ng="http://angularjs.org" id="ng-app" ng-app="tradeApp" ng-controller="tradeController" ng-cloak>
	<head>
		...
		<script src="<?php echo asset_url();?>js/trade.min3aeb.js" type="text/javascript" charset="utf-8"></script>
...
<div ng-controller="headCtr">
		...
		<div class="header">
			<a href="<?php echo base_url();?>" class="logo"><img src="	<?php echo asset_url();?>img/binance-replica-l-w.png"/></a>
			...
			<ul class="main-nav exchange" ng-if="notChinese">
					<li>
						...
						<ul class="subNav">
							<li><a href="<?php echo trading_url();?>trade?curr=<?php echo base64_encode("BCH/INR");?>">Basic</a></li>
