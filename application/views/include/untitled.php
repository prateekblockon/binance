...
url_api = '<?php echo URL_API;?>';
 function bidAmount() {
     ...
     function bidAmountTotal()
      ...
      function askAmount() {
          var a = new BigNumber(document.getElementById('ask_vol').value);
          var b = new BigNumber(document.getElementById('ask_rate').value);
          var result = (a).times(b);
          if (!isNaN(result)) {
...
function del(bidId,bidownerId) {
    alertify.confirm('Do you really want to remove your bid?',function(){
      $.ajax({
        ...
        success: function(result){
          toastr["success"]("Your Bid delete Successfully", "Success");
        }
      });
    });
  }
  function del_ask(askId,askownerId) {
    alertify.confirm('Do you really want to remove your ask?',function(){
      $.ajax({
        ...
        success: function(result){
          toastr["success"]("Your Ask delete Successfully", "Success");
...
usersmarket('<?php echo $currencyname?>');
getCurrentAskPrice();
