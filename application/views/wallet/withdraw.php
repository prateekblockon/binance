...
.scrollStyle{overflow-y:auto;   height: 163px;} 
  ...
  <div class="safetitle">Withdraw <?php echo $currency; ?></div>
    ...
    <div class="addressManament-form">
      ...
      <div class="leftBox">
        <form >
          ...
          <div class="filed">
            <label></label> 
            <input type="button" value="Withdraw" onclick="withdraw();" class="btn btn-orange" style="width: 156px; text-align: center; padding: 10px 20px;" />
          </div>
        </form>
      </div>
