			...
			<input type="hidden" id="curr"  value="<?php echo $currency; ?>">
				...
				<div class="userRecords f-cb" >
					<div class="userRecords-title">
						<span class="cur">Transaction <?php echo $currency;?> </span>
					...
					<div class="userRecords-main">
						...
						<div class="item-con">
							<table class="table table-striped">
								...
								<thead>
									<tr>
									    <th class="f-left">Currency</th>
										<th class="f-left">Address</th>
										<th class="f-center">Amount</th>
										<th class="f-center">Confirmations</th>
										<th class="f-center">Category</th>
