			...
			<input type="hidden" id="subcurr" value="<?php echo $subcurr; ?>">
				...
				<div class="main-body">
								...
								<form name="buyForm"  novalidate autocomplete="off">
									...
									<div class="orderforms-inputs">
										...
										<div class="field f-cb">
											...
											<div class="iptwrap" >
												<input type="text" name="buyQuanity" id="buyQuanity" required ng-keyup="checkinput($event,currentProduct.qtyTick)"  ng-blur="maxQuantity=false;" onpaste="return false" ng-focus="maxQuantity=true;hideerror($event,'buyform-error')" ng-model="buy_order.quantity"   />
									...
									<?php if($this->session->userdata('_id')=='')
										...
										<input type="submit" onclick="but_data();" value="{{'Buy' | T}} {{currentProduct.baseAsset}} <?php echo $maincurr; ?>" class="btn btn-block btn-buy" />
										<?php } ?>
									</div>
								</form>
							</div>
								...
								<form name="sellForm"  autocomplete="off">
									...
									<div class="orderforms-inputs">
										...
										<div class="field f-cb">
											<label>{{'price'|T}}: </label>
											<div class="iptwrap leftBig">
												<input type="text" name="sellPrice" id="sellPrice" required ng-keyup="checkinput($event,currentProduct.priceTick)" onpaste="return false" ng-focus="hideerror($event,'sellform-error')"   ng-model="sell_order.sell_price"/>
										...
										<div class="field f-cb">
											...
											<div class="iptwrap" ng-init="sell_maxQuantity=false">
												<input type="text" name="sellQuanity" id="sellQuanity" ng-keyup="checkinput($event,currentProduct.qtyTick)"  ng-blur="sell_maxQuantity=false;" onpaste="return false" ng-focus="sell_maxQuantity=true;hideerror($event,'sellform-error')"   ng-model="sell_order.sell_quantity" required />
									...
									<?php if($this->session->userdata('_id')=='')
										...
										<input type="submit" onclick="sell_data();" value="{{'Sell' | T}} {{currentProduct.baseAsset}} <?php echo $maincurr; ?>"  class="btn btn-block btn-sell"  />
										<?php } ?>
									</div>
					...
					<div class="main-aside" style="top:-58px;">
						...
						<div style="height:247px;overflow-y:auto;" class="scrollStyle" ng-if="tradesType.type=='marketTrades'">
				...
				<div class="userRecords f-cb" >
					<div class="userRecords-title">
						<span class="cur" style="color: black;">{{'My 24h Order History'|T}}</span>
						<span class="cur" style="color: black;float: right;"><a href="<?php echo trading_url();?>/tradehistory"> more </a> </span>
					</div>
					<div class="userRecords-main">
							<!-- 历史委托 -->
							<div class="item-con">
