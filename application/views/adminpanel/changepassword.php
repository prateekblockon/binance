...
<head>
    ...
    ?>
        ...
        <?php } ?>
          <div class="leftBox">
        <form action="<?php echo admin_url();?>changepassword/changepassword" method="post" id="changepassform">
          <div class="filed">
          ...
          <div class="filed">
            ...
            <input id="repeatPassword" name="repeatPassword"  recheck="newPassword"  type="password" />
